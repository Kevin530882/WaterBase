...
export const ActivityLogRouter = lazy(() => import('./ActivityLogRouter').then(m => ({ default: m.ActivityLogRouter })));
...
export const AdminDevices = lazy(() => import('./AdminDevices').then(m => ({ default: m.AdminDevices })));
export const AdminDeviceDetail = lazy(() => import('./AdminDeviceDetail').then(m => ({ default: m.AdminDeviceDetail })));
